...
#sub graph 1
with(hpc, plot(DateTime, globalactivepower, type="l", xlab="", ylab="Global Active Power"))
...
#sub graph 4
with(hpc, plot(DateTime, globalreactivepower, type="l", xlab="datetime", ylab="Global Reactive Power"))
dev.off()
}